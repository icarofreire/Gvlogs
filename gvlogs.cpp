...
// void Gvlogs::vector_delete(int index)
// {
//     if (index < 0 || index >= MAXIMO_ABAS)
//         return;
//
//     // scroll[index] = NULL;
//
//     for (int i = index; i < MAXIMO_ABAS - 1; i++) {
//         scroll[i] = scroll[i + 1];
//         // scroll[i + 1] = NULL;
//     }
// }
